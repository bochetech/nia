...
function fsmStateBadgeColor(state: string): string {
  const map: Record<string, string> = {
    ...
    greeting:         "bg-blue-500/10 text-blue-500 border-blue-500/20",
    discovery:        "bg-indigo-500/10 text-indigo-500 border-indigo-500/20",
    faq_answer:       "bg-emerald-500/10 text-emerald-500 border-emerald-500/20",
    recommending:     "bg-amber-500/10 text-amber-500 border-amber-500/20",
    product_selected: "bg-orange-500/10 text-orange-500 border-orange-500/20",
    checkout_init:    "bg-pink-500/10 text-pink-500 border-pink-500/20",
    awaiting_payment: "bg-purple-500/10 text-purple-500 border-purple-500/20",
    confirmed:        "bg-green-500/10 text-green-500 border-green-500/20",
    handoff_active:   "bg-red-500/10 text-red-500 border-red-500/20",
    closed:           "bg-muted text-muted-foreground border-border",
  };
  return map[state] ?? "bg-primary/10 text-primary border-primary/20";
}
          ...
          <div className="flex-1 flex flex-col overflow-hidden">
            <div className="px-4 py-2 border-b bg-card flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[12px] font-semibold text-foreground">Event Trace</span>
              </div>
